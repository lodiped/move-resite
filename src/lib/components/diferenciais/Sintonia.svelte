...
<p class="text-sm lg:text-md">
	...
	e orientada para decisões estratégicas. Além dos serviços operacionais, oferecemos direcionamento
	para que sua empresa cresça com confiança e consistência.
</p>
